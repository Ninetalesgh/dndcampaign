...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
Each creature in a radius 2 *(3m)* sphere centered on a point you choose within range must succeed on a WIS Save, or that target can't take Bonus Actions or Reactions and must roll 1d10 at the start of each of its turns to determine its behavior for that turn, consulting the table below.
1d10Behavior for the Turn1The target doesn't take an action, and it uses all its movement to move. Roll 1d4 for the direction: 1, north; 2, east; 3, south; or 4, west.
...
You have Advantage on STR Saves while you're within 1 *(1.5m)* of the pack, and when you move on your turn, you can also move the pack up to 6 *(9m)* to an unoccupied space you can see.
Whenever the pack moves within 2 *(3m)* of a creature you can see and whenever a creature you can see enters a space within 2 *(3m)* of the pack or ends its turn there, you can force that creature to make a DEX Save. On a failed save, the creature takes 3d10 Slashing damage. A creature makes this save only once per turn.
**Using a Higher-Level Spell Slot.** The damage increases by 1d10 for each spell slot level above 3.
- **Classes**: Druid, Ranger
...
Searing Light. The target makes a DEX Save, taking 6d12 Radiant damage on a failed save or half as much damage on a successful one.
Until the spell ends, Bright Light fills the Cylinder, and when you move on your turn, you can also move the Cylinder up to 6 *(9m)*.
...
As a Bonus Action on your later turns, you can teleport the spirit to an unoccupied space you can see within 6 *(9m)* of the space it left and make the attack against a creature within 1 *(1.5m)* of it.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
You conjure spirits from the Elemental Planes that flit around you in a radius 3 *(4.5m)* emanation for the duration. Until the spell ends, any attack you make deals an extra 2d8 damage when you hit a creature in the Emanation. This damage is Acid, Cold, Fire, or Lightning (your choice when you make the attack).
...
- **Components**: V, S
- **Duration**: 7 days
Your touch inflicts a magical contagion. The target must succeed on a CON Save or take 11d8 Necrotic damage and be [Poisoned](conditions.md#poisoned). Also, choose one ability when you cast the spell. While [Poisoned](conditions.md#poisoned), the target has Disadvantage on Saves made with the chosen ability.
...
You choose nonmagical flame that you can see within range and that fits within a size 1 *(1.5m)* cube. You affect it in one of the following ways:You instantaneously expand the flame 1 *(1.5m)* in one direction, provided that wood or other fuel is present in the new location.
...
- **Components**: V, S
- **Duration**: Until dispelled
You imbue an object that you touch with evil power that radiates palpably in a radius 6 *(9m)* sphere.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
One creature that you can see within range must succeed on a WIS Save or be [Charmed](conditions.md#charmed) for the duration. The creature succeeds automatically if it isn't Humanoid.
...
- **Components**: V, S
- **Duration**: Until dispelled
A burst of black fire erupts in a radius 3 *(4.5m)* circle centered on a point you can see within 24 *(36m)*, leaving behind an area of magical darkness.
...
- **Components**: V
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
For the duration, magical Darkness spreads from a point within range and fills a radius 3 *(4.5m)* sphere. Darkvision can't see through it, and nonmagical light can't illuminate it.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
The light of dawn shines down on a location you specify within range. Until the spell ends, a radius 6 *(9m)* sphere, height 8 *(12m)* cylinder of bright light glimmers there. This light is sunlight.
When the cylinder appears, each creature in it must make a CON Save, taking 4d10 radiant damage on a failed save, or half as much damage on a successful one. A creature must also make this Save whenever it ends its turn in the cylinder.
If you're within 12 *(18m)* of the cylinder, you can move it up to 12 *(18m)* as a bonus action on your turn.
- **Classes**: Cleric, Wizard
*(Source: XGE, page 153)*
...
- **Components**: V, S
- **Duration**: 1 hour
For the duration, sunlight spreads from a point within range and fills a radius 12 *(18m)* sphere. The sunlight's area is Bright Light and sheds Dim Light for an additional 12 *(18m)*.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
 globe of crystal poison envelops a Huge or smaller creature you can see within range and begins to fill with sickening fumes.
...
- **Components**: S
- **Duration**: 1 hour
You create a shadowy Medium door on a flat solid surface that you can see within range. This door can be opened and closed, and it leads to a demiplane that is an empty room 6 *(9m)* in each dimension, made of wood or stone (your choice).
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
For the duration, you sense the location of poisons, poisonous or venomous creatures, and magical contagions within 6 *(9m)* of yourself. You sense the kind of poison, creature, or contagion in each case.
The spell is blocked by 30cm of stone, dirt, or wood; 3cm of metal; or a thin sheet of lead.
- **Classes**: Cleric, Druid, Paladin, Ranger
*(Source: PHB'24, page 262)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
An acrid rain begins to fall in a radius 3 *(4.5m)*, height 60 *(90m)* cylinder centered on a point you can see within range.
...
- **Components**: V
- **Duration**: Instantaneous
You teleport to a location within range. You arrive at exactly the spot desired. It can be a place you can see, one you can visualize, or one you can describe by stating distance and direction, such as ""40 *(60m)* straight downward"" or ""60 *(90m)* upward to the northwest at a 45-degree angle.
...
A creature targeted by this spell makes a DEX Save. On a failed save, the target takes 10d6 + 40 Force damage. If this damage reduces it to 0 Hit Points, it and everything nonmagical it is wearing and carrying are disintegrated into gray dust. The target can be revived only by a True Resurrection or a Wish spell.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You choose a point you can see within range, twisting and altering gravity for creatures in a radius 3 *(4.5m)* circle centered on it.
...
41-50The target is [Deafened](conditions.md#deafened) for 1 minute.
- **Classes**: Cleric
*(Source: PHB'24, page 265)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
One Beast you can see within range must succeed on a WIS Save or be [Charmed](conditions.md#charmed) for the duration. The target has Advantage on the save if you or your allies are fighting it. Whenever the target takes damage, it repeats the save, ending the spell on itself on a success.
You have a telepathic link with the [Charmed](conditions.md#charmed) target while the two of you are on the same plane of existence. On your turn, you can use this link to issue commands to the target (no action required), such as ""Attack that creature,"" ""Move over there,"" or ""Fetch that object.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 hour
One creature you can see within range must succeed on a WIS Save or be [Charmed](conditions.md#charmed) for the duration. The target has Advantage on the save if you or your allies are fighting it. Whenever the target takes damage, it repeats the save, ending the spell on itself on a success.
You have a telepathic link with the [Charmed](conditions.md#charmed) target while the two of you are on the same plane of existence. On your turn, you can use this link to issue commands to the target (no action required), such as ""Attack that creature,"" ""Move over there,"" or ""Fetch that object.
"" The target does its best to obey on its turn. If it completes an order and doesn't receive further direction from you, it acts and moves as it likes, focusing on protecting itself.
You can command the target to take a Reaction but must take your own Reaction to do so.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
One Humanoid you can see within range must succeed on a WIS Save or be [Charmed](conditions.md#charmed) for the duration. The target has Advantage on the save if you or your allies are fighting it. Whenever the target takes damage, it repeats the save, ending the spell on itself on a success.
You have a telepathic link with the [Charmed](conditions.md#charmed) target while the two of you are on the same plane of existence. On your turn, you can use this link to issue commands to the target (no action required), such as ""Attack that creature,"" ""Move over there,"" or ""Fetch that object.
"" The target does its best to obey on its turn. If it completes an order and doesn't receive further direction from you, it acts and moves as it likes, focusing on protecting itself.
You can command the target to take a Reaction but must take your own Reaction to do so.
...
Breath Weapon. When you cast this spell, and as a bonus action on subsequent turns for the duration, you can exhale shimmering energy in a length 12 *(18m)* cone. Each creature in that area must make a DEX Save, taking 6d8 force damage on a failed save, or half as much damage on a successful one.
Wings. Incorporeal wings sprout from your back, giving you a flying speed of 12 *(18m)*.
- **Classes**: Druid, Sorcerer, Wizard
*(Source: FTD, page 19)*
...
- **Components**: V, S
- **Duration**: Until dispelled
You touch the sapphire used in the casting and an object weighing 5kg or less whose longest dimension is 2 meters or less. The spell leaves an [Invisible](conditions.md#invisible) mark on that object and invisibly inscribes the object's name on the sapphire. Each time you cast this spell, you must use a different sapphire.
...
- **Components**: V, S
- **Duration**: 8 hours
You target a creature you know on the same plane of existence. You or a willing creature you touch enters a trance state to act as a dream messenger. While in the trance, the messenger is [Incapacitated](conditions.md#incapacitated) and has a Speed of 0.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
Choose a point on the ground that you can see within range. For the duration, an intense tremor rips through the ground in a radius 20 *(30m)* circle centered on that point. The ground there is Difficult Terrain.
When you cast this spell and at the end of each of your turns for the duration, each creature on the ground in the area makes a DEX Save. On a failed save, a creature is [Prone](conditions.md#prone), and its Concentration is broken.
You can also cause the effects below. Fissures. A total of 1d6 fissures open in the spell's area at the end of the turn you cast it. You choose the fissures' locations, which can't be under structures. Each fissure is 1d10 × 2 *(3m)* deep and 2 *(3m)* wide, and it extends from one edge of the spell's area to another edge. A creature in the same space as a fissure must succeed on a DEX Save or fall in. A creature that successfully saves moves with the fissure's edge as it opens. Structures. The tremor deals 50 Bludgeoning damage to any structure in contact with the ground in the area when you cast the spell and at the end of each of your turns until the spell ends. If a structure drops to 0 Hit Points, it collapses.
...
- **Components**: S
- **Duration**: 8 hours
Putting a finger to your head, you pull a memory, an idea, or a message from your mind and transform it into a tangible string of glowing energy called a thought strand, which persists for the duration or until you cast this spell again. The thought strand appears in an unoccupied space within 1 *(1.5m)* of you as a Tiny, weightless, semisolid object that can be held and carried like a ribbon. It is otherwise stationary.
...
- **Components**: V, S
- **Duration**: Instantaneous
You release a burst of reanimating spores in a radius 6 *(9m)* sphere centered on a point you can see within range.
...
- **Enlarge**. The target's size increases by one category—from Medium to Large, for example. The target also has Advantage on STR checks and STR Saves. The target's attacks with its enlarged weapons or Unarmed Strikes deal an extra 1d4 damage on a hit. 
- **Reduce**. The target's size decreases by one category—from Medium to Small, for example. The target also has Disadvantage on STR checks and STR Saves. The target's attacks with its reduced weapons or Unarmed Strikes deal 1d4 less damage on a hit (this can't reduce the damage below 1).
- **Classes**: Artificer, Bard, Druid, Sorcerer, Wizard
![\|50](https://bg3.wiki/w/images/c/c6/Enlarge_Reduce_Icon.webp)
*(Source: PHB'24, page 268)*
...
- **Components**: V
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
As you hit the target, grasping vines appear on it, and it makes a STR Save. A Large or larger creature has Advantage on this save. On a failed save, the target is [Restrained](conditions.md#restrained) until the spell ends. On a successful save, the vines shrivel away, and the spell ends.
...
- **Components**: V, S
- **Duration**: 8 hours
You step into the border regions of the Ethereal Plane, where it overlaps with your current plane. You remain in the Border Ethereal for the duration. During this time, you can move in any direction. If you move up or down, movement costs double. You can perceive the plane you left, which looks gray, and you can't see anything there more than 12 *(18m)* away.
...
When the spell ends, you return to the plane you left in the spot that corresponds to your space in the Border Ethereal. If you appear in an occupied space, you are shunted to the nearest unoccupied space and take 10 Force damage for each square you are moved.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
Squirming, ebony tentacles fill a size 4 *(6m)* square on ground that you can see within range. For the duration, these tentacles turn the ground in that area into Difficult Terrain.
...
- **Components**: V, S
- **Duration**: Instantaneous
You summon a spirit that assumes the form of a loyal, majestic mount. Appearing in an unoccupied space within range, the spirit takes on a form you choose: a griffon, a pegasus, a peryton, a dire wolf, a rhinoceros, or a saber-toothed tiger. The creature has the statistics provided in the Monster Manual for the chosen form, though it is a celestial, a fey, or a fiend (your choice) instead of its normal creature type. Additionally, if it has an INT score of 5 or lower, its INT becomes 6, and it gains the ability to understand one language of your choice that you speak.
...
- **Components**: V, S
- **Duration**: Instantaneous
You unleash negative energy toward a creature you can see within range. The target makes a CON Save, taking 7d8 + 30 Necrotic damage on a failed save or half as much damage on a successful one.
...
- **Components**: V, S
- **Duration**: 10 minutes
Wispy flames wreathe your body for the duration, shedding Bright Light in a radius 2 *(3m)* sphere and Dim Light for an additional 2 *(3m)*.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You create a field of silvery light that surrounds a creature of your choice within range (you can choose yourself). The field sheds dim light out to 1 *(1.5m)*. While surrounded by the field, a creature gains the following benefits:Cover. The creature has half cover.
Damage Resistance. The creature has resistance to acid, cold, fire, lightning, and poison damage.
Evasion. If the creature is subjected to an effect that allows it to make a DEX Save to take only half damage, the creature instead takes no damage if it succeeds on the Save, and only half damage if it fails.
As a bonus action on subsequent turns, you can move the field to another creature within 12 *(18m)* of the field.
- **Classes**: Sorcerer, Wizard
*(Source: FTD, page 20)*
...
- **Components**: V, S
- **Duration**: Instantaneous
Your eyes blaze with abyssal flame as you lift a [grappled](conditions.md#grappled) creature aloft and scream at it with such STR its flesh begins to peel away.
...
- **Components**: V, S
- **Duration**: 1 day
You create a ward against magical travel that protects up to 4000 m² of floor space to a height of 6 *(9m)* above the floor. For the duration, creatures can't teleport into the area or use portals, such as those created by the Gate spell, to enter the area. The spell proofs the area against planar travel, and therefore prevents creatures from accessing the area by way of the Astral Plane, the Ethereal Plane, the Feywild, the Shadowfell, or the Plane Shift spell.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
A cool light wreathes your body for the duration, emitting Bright Light in a radius 4 *(6m)* sphere and Dim Light for an additional 4 *(6m)*.
...
In addition, immediately after you take damage from a creature you can see within 12 *(18m)* of yourself, you can take a Reaction to force the creature to make a CON Save. On a failed save, the creature is [Blinded](conditions.md#blinded) until the end of your next turn.
- **Classes**: Bard, Druid
...
- **Components**: V, S
- **Duration**: Instantaneous
You cause numbing frost to form on one creature that you can see within range. The target must make a CON Save. On a failed save, the target takes 1d6 cold damage, and it has disadvantage on the next weapon attack roll it makes before the end of its next turn.
...
- **Duration**: Special
Concentration.
Each area affected by the Sprouting Doom spell within range releases a cloud of hallucinogenic spores in a radius 6 *(9m)* sphere centered on itself.
Each of these areas is heavily obscured, and a creature that starts its turn in one or more of these areas must succeed on a CON Save or be [Poisoned](conditions.md#poisoned) until the start of its next turn.
...
While in this form, the target's only method of movement is a Fly Speed of 2 *(3m)*, and it can hover. The target can enter and occupy the space of another creature. The target has Resistance to Bludgeoning, Piercing, and Slashing damage; it has Immunity to the [Prone](conditions.md#prone) condition; and it has Advantage on STR, DEX, and CON Saves. The target can pass through narrow openings, but it treats liquids as though they were solid surfaces.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
An immobile, shimmering barrier appears in a radius 2 *(3m)* emanation around you and remains for the duration.
...
- **Components**: S
- **Duration**: Instantaneous
You brandish the weapon used in the spell's casting and make a melee attack with it against one creature within 1 *(1.5m)* of you. On a hit, the target suffers the weapon attack's normal effects, and you can cause green fire to leap from the target to a different creature of your choice that you can see within 1 *(1.5m)* of it. The second creature takes fire damage equal to your spellcasting ability modifier.
...
- **Components**: V
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
A nature spirit answers your call and transforms you into a powerful guardian. The transformation lasts until the spell ends. You choose one of the following forms to assume: Primal Beast or Great Tree. Primal Beast. Bestial fur covers your body, your facial features become feral, and you gain the following benefits:Your walking speed increases by 2 *(3m)*.
You gain darkvision with a range of 24 *(36m)*.
You make STR-based attack rolls with advantage.
Your melee weapon attacks deal an extra 1d6 force damage on a hit. Great Tree. Your skin appears barky, leaves sprout from your hair, and you gain the following benefits:You gain 10 temporary hit points.
You make CON Saves with advantage.
You make DEX- and WIS-based attack rolls with advantage.
While you are on the ground, the ground within 3 *(4.5m)* of you is difficult terrain for your enemies.
- **Classes**: Druid, Ranger
*(Source: XGE, page 157)*
...
- **Components**: V, S
- **Duration**: Instantaneous
You seize the air and compel it to create one of the following effects at a point you can see within range:One Medium or smaller creature that you choose must succeed on a STR Save or be pushed up to 1 *(1.5m)* away from you.
You create a small blast of air capable of moving one object that is neither held nor carried and that weighs no more than 2.5kg. The object is pushed up to 2 *(3m)* away from you. It isn't pushed with enough force to cause damage.
...
Fear. Creatures of any types you choose be [Frightened](conditions.md#frightened) while in the area.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
A thin sheet of evil flame traces out a cubic barrier, 6 *(9m)* to a side, centered on a point you can see within range. When the barrier appears, each creature whose space it passes through is pushed to the nearest unoccupied space within the barrier.
...
- **Components**: V, S
- **Duration**: Instantaneous
You harvest life energy from your allies to fuel an evil flame. Up to 10 willing creatures within range each lose Hit Points equal to 1/10 their Hit Point maximum (rounded up).
...
- **Components**: V, S
- **Duration**: Instantaneous
Flames erupt from your flesh to engulf a creature [grappled](conditions.md#grappled) by you, forcing the creature to succeed on a CON Save or take 8d10 Fire damage or half as much on a success.
...
As a bonus action on your turn, you can dismiss this spell and cause the weapon to emit a burst of radiance. Each creature of your choice that you can see within 6 *(9m)* of the weapon must make a CON Save. On a failed save, a creature takes 4d8 radiant damage, and it is [blinded](conditions.md#blinded) for 1 minute. On a successful save, a creature takes half as much damage and isn't [blinded](conditions.md#blinded). At the end of each of its turns, a [blinded](conditions.md#blinded) creature can make a CON Save, ending the effect on itself on a success.
- **Classes**: Cleric, Paladin
*(Source: XGE, page 157)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You open a gateway to the Far Realm, a region infested with unspeakable horrors. a radius 4 *(6m)* sphere of Darkness appears, centered on a point with range and lasting for the duration. The Sphere is Difficult Terrain, and it is filled with strange whispers and slurping noises, which can be heard up to 6 *(9m)* away. No light, magical or otherwise, can illuminate the area, and creatures fully within it be [Blinded](conditions.md#blinded).
...
- **Components**: V
- **Duration**: [Concentration](conditions.md#concentration), up to 1 hour
You magically mark one creature you can see within range as your quarry. Until the spell ends, you deal an extra 1d6 Force damage to the target whenever you hit it with an attack roll. You also have Advantage on any WIS (Perception or Survival) check you make to find it.
...
- **Components**: V, S
- **Duration**: Instantaneous
Hail falls in a radius 4 *(6m)* sphere, height 8 *(12m)* Cylinder centered on a point within range. Each creature in the Cylinder makes a DEX Save. A creature takes 2d10 Bludgeoning damage and 4d6 Cold damage on a failed save or half as much damage on a successful one.
...
When the illusion appears, any of your enemies that can see it must succeed on a WIS Save or become [frightened](conditions.md#frightened) of it for 1 minute. If a [frightened](conditions.md#frightened) creature ends its turn in a location where it doesn't have line of sight to the illusion, it can repeat the Save, ending the effect on itself on a success.
As a bonus action on your turn, you can move the illusion up to 12 *(18m)*. At any point during its movement, you can cause it to exhale a blast of energy in a length 12 *(18m)* cone originating from its space. When you create the dragon, choose a damage type: acid, cold, fire, lightning, necrotic, or poison. Each creature in the cone must make an INT Save, taking 7d6 damage of the chosen damage type on a failed save, or half as much damage on a successful one.
The illusion is tangible because of the shadow stuff used to create it, but attacks miss it automatically, it succeeds on all Saves, and it is immune to all damage and conditions. A creature that uses an action to examine the dragon can determine that it is an illusion by succeeding on an INT (Investigation) check against your spell save DC. If a creature discerns the illusion for what it is, the creature can see through it and has advantage on Saves against its breath.
- **Classes**: Wizard
*(Source: XGE, page 157)*
...
- **Components**: V, S
- **Duration**: Until dispelled
You create a magical restraint to hold a creature that you can see within range. The target must make a WIS Save. On a successful save, the target is unaffected, and it is immune to this spell for the next 24 hours. On a failed save, the target is imprisoned. While imprisoned, the target doesn't need to breathe, eat, or drink, and it doesn't age. Divination spells can't locate or perceive the imprisoned target, and the target can't teleport.
...
- *Chaining.* Chains firmly rooted in the ground hold the target in place. The target is [Restrained](conditions.md#restrained) and can't be moved by any means.
...
- *Minimus Containment.* The target becomes 3cm tall and is trapped inside an indestructible gemstone or a similar object. Light can pass through the gemstone (allowing the target to see out and other creatures to see in), but nothing else can pass through by any means.
- *Slumber.* The target is [Unconscious](conditions.md#unconscious) and can't be awoken.
...
At the end of each of its turns, an affected target can make a WIS Save. If it succeeds, this effect ends for that target.
- **Classes**: Cleric, Warlock, Wizard
*(Source: AI, page 76)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
Swarming locusts fill a radius 4 *(6m)* sphere centered on a point you choose within range. The Sphere remains for the duration, and its area is Lightly Obscured and Difficult Terrain.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
Flames race across your body, shedding bright light in a radius 6 *(9m)* sphere and dim light for an additional 6 *(9m)* for the spell's duration. The flames don't harm you. Until the spell ends, you gain the following benefits:You are immune to fire damage and have resistance to cold damage.
Any creature that moves within 1 *(1.5m)* of you for the first time on a turn or ends its turn there takes 1d10 fire damage.
You can use your action to create a line of fire 3 *(4.5m)* long and 1 *(1.5m)* wide extending from you in a direction you choose. Each creature in the line must make a DEX Save. A creature takes 4d8 fire damage on a failed save, or half as much damage on a successful one.
- **Classes**: Druid, Sorcerer, Warlock, Wizard
*(Source: XGE, page 159)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
Until the spell ends, ice rimes your body, and you gain the following benefits:You are immune to cold damage and have resistance to fire damage.
You can move across difficult terrain created by ice or snow without spending extra movement.
The ground in a radius 2 *(3m)* sphere around you is icy and is difficult terrain for creatures other than you. The radius moves with you.
You can use your action to create a length 3 *(4.5m)* cone of freezing wind extending from your outstretched hand in a direction you choose. Each creature in the cone must make a CON Save. A creature takes 4d6 cold damage on a failed save, or half as much damage on a successful one. A creature that fails its save against this effect has its speed halved until the start of your next turn.
- **Classes**: Druid, Sorcerer, Warlock, Wizard
*(Source: XGE, page 159)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
Until the spell ends, bits of rock spread across your body, and you gain the following benefits:You have resistance to bludgeoning, piercing, and slashing damage from nonmagical attacks.
You can use your action to create a small earthquake on the ground in a radius 3 *(4.5m)* sphere centered on you. Other creatures on that ground must succeed on a DEX Save or be knocked [prone](conditions.md#prone).
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
Until the spell ends, wind whirls around you, and you gain the following benefits:Ranged weapon attacks made against you have disadvantage on the attack roll.
You gain a flying speed of 12 *(18m)*. If you are still flying when the spell ends, you fall, unless you can somehow prevent it.
You can use your action to create a size 3 *(4.5m)* cube of swirling wind centered on a point you can see within 12 *(18m)* of you. Each creature in that area must make a CON Save. A creature takes 2d10 bludgeoning damage on a failed save, or half as much damage on a successful one. If a Large or smaller creature fails the save, that creature is also pushed up to 2 *(3m)* away from the center of the cube.
- **Classes**: Druid, Sorcerer, Warlock, Wizard
*(Source: XGE, page 160)*
...
- **Components**: V, S
- **Duration**: Until dispelled
You hide a chest and all its contents on the Ethereal Plane. You must touch the chest and the miniature replica that serve as Material components for the spell. The chest can contain up to 350 liters of nonliving material.
While the chest remains on the Ethereal Plane, you can take a Magic action and touch the replica to recall the chest. It appears in an unoccupied space on the ground within 1 *(1.5m)* of you. You can send the chest back to the Ethereal Plane by taking a Magic action to touch the chest and the replica.
...
- **Components**: V, S
- **Duration**: 8 hours
a radius 2 *(3m)* emanation springs into existence around you and remains stationary for the duration. The spell fails when you cast it if the Emanation isn't big enough to fully encapsulate all creatures in its area.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
One creature or loose object of your choice that you can see within range rises vertically up to 4 *(6m)* and remains suspended there for the duration. The spell can levitate an object that weighs up to 250kg. An unwilling creature that succeeds on a CON Save is unaffected.
...
- **Components**: V, S
- **Duration**: Instantaneous
As your attack hits or misses the target, the weapon or ammunition you're using transforms into a lightning bolt. Instead of taking any damage or other effects from the attack, the target takes 4d8 Lightning damage on a hit or half as much damage on a miss. Each creature within 2 *(3m)* of the target then makes a DEX Save, taking 2d8 Lightning damage on a failed save or half as much damage on a successful one.
...
- **Components**: V
- **Duration**: Instantaneous
You create a lash of lightning energy that strikes at one creature of your choice that you can see within 3 *(4.5m)* of you. The target must succeed on a STR Save or be pulled up to 2 *(3m)* in a straight line toward you and then take 1d8 lightning damage if it is within 1 *(1.5m)* of you.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 hour
Describe or name a creature that is familiar to you. You sense the direction to the creature's location if that creature is within 1,0 *(0m)* of you. If the creature is moving, you know the direction of its movement.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
Describe or name an object that is familiar to you. You sense the direction to the object's location if that object is within 1,0 *(0m)* of you. If the object is in motion, you know the direction of its movement.
The spell can locate a specific object known to you if you have seen it up close—within 6 *(9m)*—at least once. Alternatively, the spell can locate the nearest object of a particular kind, such as a certain kind of apparel, jewelry, furniture, tool, or weapon.
...
Shrieks, gibbering, and mad laughter can be heard within the sphere. Whenever a creature starts its turn in the sphere, it must make a WIS Save, taking 8d8 psychic damage on a failed save, or half as much damage on a successful one.
- **Classes**: Warlock, Wizard
*(Source: XGE, page 160)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
Whispering darkness boils forth in a radius 4 *(6m)* sphere from a point you can see within range, extinguishing all lights in the area.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
A swirling mass of depth 1 *(1.5m)* water appears in a radius 6 *(9m)* circle centered on a point you can see within range. The point must be on the ground or in a body of water. Until the spell ends, that area is difficult terrain, and any creature that starts its turn there must succeed on a STR Save or take 6d6 bludgeoning damage and be pulled 2 *(3m)* toward the center.
- **Classes**: Druid
*(Source: XGE, page 160)*
...
- **Components**: V, S
- **Duration**: 1 minute
A spectral, floating hand appears at a point you choose within range. The hand lasts for the duration. The hand vanishes if it is ever more than 6 *(9m)* away from you or if you cast this spell again.
...
The trigger can be as general or as detailed as you like, though it must be based on visual or audible conditions that occur within 6 *(9m)* of the object. For example, you could instruct the mouth to speak when any creature moves within 6 *(9m)* of the object or when a silver bell rings within 6 *(9m)* of it.
- **Classes**: Artificer, Bard, Wizard
*(Source: PHB'24, page 295)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
You create the image of an object, a creature, or some other visible phenomenon that is no larger than a size 4 *(6m)* cube. The image appears at a spot that you can see within range and lasts for the duration. It seems real, including sounds, smells, and temperature appropriate to the thing depicted, but it can't deal damage or cause conditions.
...
As an action, you can cause the hand to crush the [restrained](conditions.md#restrained) target, which must make a STR Save. The target takes 2d6 bludgeoning damage on a failed save, or half as much damage on a successful one.
To break out, the [restrained](conditions.md#restrained) target can use its action to make a STR check against your spell save DC. On a success, the target escapes and is no longer [restrained](conditions.md#restrained) by the hand.
...
The target can take a Study action to try to escape. When it does so, it makes a DC 20 INT (Investigation) check. If it succeeds, it escapes, and the spell ends.
...
While merged with the stone, you can't see what occurs outside it, and any WIS (Perception) checks you make to hear sounds outside it are made with Disadvantage. You remain aware of the passage of time and can cast spells on yourself while merged in the stone. You can use 1 *(1.5m)* of movement to leave the stone where you entered it, which ends the spell. You otherwise can't move.
...
- **Components**: V, S
- **Duration**: Instantaneous
A fortress of stone erupts from a square area of ground of your choice that you can see within range. The area is 24 *(36m)* on each side, and it must not have any buildings or other structures on it. Any creatures in the area are harmlessly lifted up as the fortress rises.
The fortress has four turrets with square bases, each one 4 *(6m)* on a side and 6 *(9m)* tall, with one turret on each corner. The turrets are connected to each other by stone walls that are each 16 *(24m)* long, creating an enclosed area. Each wall is 30cm thick and is composed of panels that are 2 *(3m)* wide and 4 *(6m)* tall. Each panel is contiguous with two other panels or one other panel and a turret. You can place up to four stone doors in the fortress's outer wall.
A small keep stands inside the enclosed area. The keep has a square base that is 10 *(15m)* on each side, and it has three floors with height 2 *(3m)* ceilings. Each of the floors can be divided into as many rooms as you like, provided each room is at least 1 *(1.5m)* on each side. The floors of the keep are connected by stone staircases, its walls are 15cm thick, and interior rooms can have stone doors or open archways as you choose. The keep is furnished and decorated however you like, and it contains sufficient food to serve a nine-course banquet for up to 100 people each day. Furnishings, food, and other objects created by this spell crumble to dust if removed from the fortress.
A staff of one hundred [invisible](conditions.md#invisible) servants obeys any command given to them by creatures you designate when you cast the spell. Each servant functions as if created by the unseen servant spell.
The walls, turrets, and keep are all made of stone that can be damaged. Each 2-by-2 *(3m-by-3m)* section of stone has AC 15 and 30 HP per 2.5cm of thickness. It is immune to poison and psychic damage. Reducing a section of stone to 0 HP destroys it and might cause connected sections to buckle and collapse at the DM's discretion.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You attempt to reshape another creature's memories. One creature that you can see within range makes a WIS Save. If you are fighting the creature, it has Advantage on the save. On a failed save, the target is [Charmed](conditions.md#charmed) for the duration. While [Charmed](conditions.md#charmed) in this way, the target also is [Incapacitated](conditions.md#incapacitated) and is unaware of its surroundings, though it can hear you. If it takes any damage or is targeted by another spell, this spell ends, and no memories are modified.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
A silvery beam of pale light shines down in a radius 1 *(1.5m)* sphere, height 8 *(12m)* Cylinder centered on a point within range. Until the spell ends, Dim Light fills the Cylinder, and you can take a Magic action on later turns to move the Cylinder up to 12 *(18m)*.
...
- **Components**: V, S
- **Duration**: Instantaneous
You attempt to neutralize a spell as it is cast, meeting it with a tailored blend of opposing cosmic energies; fire with water, order with chaos, etc.
...
On each of your turns for the duration, you can use your bonus action to choose two creatures or objects you can see within range.
...
- **Components**: S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You fill a size 4 *(6m)* cube you can see within range with fey and draconic magic. Roll on the Mischievous Surge table to determine the magical effect produced, and roll again at the start of each of your turns until the spell ends. You can move the cube up to 2 *(3m)* before you roll.
Mischievous Surged4Effect1The smell of apple pie fills the air, and each creature in the cube must succeed on a WIS Save or become [charmed](conditions.md#charmed) by you until the start of your next turn.
2Bouquets of flowers appear all around, and each creature in the cube must succeed on a DEX Save or be [blinded](conditions.md#blinded) until the start of your next turn as the flowers spray water in their faces.
3Each creature in the cube must succeed on a WIS Save or begin giggling until the start of your next turn. A giggling creature is [incapacitated](conditions.md#incapacitated) and uses all its movement to move in a random direction.
...
- **Components**: V, S
- **Duration**: Instantaneous
You rend the veil at three points you can see within range, causing each to spill forth a torrent of negative energy in a length 4 *(6m)* cone.
...
If you target an undead with this spell, the target doesn't make a Save. Instead, roll 5d12. The target gains half the total as temporary hit points.
- **Classes**: Warlock, Wizard
*(Source: XGE, page 163)*
...
- **Components**: V, S
- **Duration**: Instantaneous
Requires language proficiency in DrowYou extinguish each light source in a radius 12 *(18m)* emanation from you, then each creature in the area must make a CON Saving Throw.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You transform an unoccupied radius 1 *(1.5m)* space filled with water that you can see within range into a Water Weird that acts on your initiative and under your mental control.
...
- **Components**: V, S
- **Duration**: Instantaneous
Flesh-melting ooze cascades down in a radius 4 *(6m)* sphere, height 20 *(30m)* cylinder centered on a point you can see within range.
...
- **Components**: V, S
- **Duration**: Instantaneous
A frigid globe streaks from you to a point of your choice within range, where it explodes in a radius 12 *(18m)* sphere. Each creature in that area makes a CON Save, taking 10d6 Cold damage on failed save or half as much damage on a successful one.
If the globe strikes a body of water, it freezes the water to a depth of 15cm over an area 6 *(9m)* square. This ice lasts for 1 minute. Creatures that were swimming on the surface of frozen water are trapped in the ice and be [Restrained](conditions.md#restrained). A trapped creature can take an action to make a STR (Athletics) check against your spell save DC to break free.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 hour
A stilling glow begins to emanate from you in a radius 6 *(9m)* sphere for the next hour.
...
- **Components**: S
- **Duration**: Instantaneous
You tear through the mind of a creature you can see within range, searching for signs of its weaknesses.
...
The target can take a Study action to examine the phantasm with an INT (Investigation) check against your spell save DC. If the check succeeds, the target realizes that the phantasm is an illusion, and the spell ends.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You tap into the nightmares of a creature you can see within range and create an illusion of its deepest fears, visible only to that creature. The target makes a WIS Save. On a failed save, the target takes 4d10 Psychic damage and has Disadvantage on ability checks and attack rolls for the duration. On a successful save, the target takes half as much damage, and the spell ends.
...
- **Components**: V, S
- **Duration**: 1 hour
A Large, quasi-real, horselike creature appears on the ground in an unoccupied space of your choice within range. You decide the creature's appearance, and it is equipped with a saddle, bit, and bridle. Any of the equipment created by the spell vanishes in a puff of smoke if it is carried more than 2 *(3m)* away from the steed.
For the duration, you or a creature you choose can ride the steed. The steed uses the Riding Horse stat block, except it has a Speed of 20 *(30m)* and can travel 13 miles in an hour. When the spell ends, the steed gradually fades, giving the rider 1 minute to dismount. The spell ends early if the steed takes any damage.
- **Classes**: Wizard
*(Source: PHB'24, page 304)*
...
- **Components**: V
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You speak a word of power that wraps one creature you can see within range in an illusory scenario in which it has been abruptly submerged in water.
...
A target suffering this pain can make a CON Save at the end of each of its turns. On a successful save, the pain ends.
- **Classes**: Sorcerer, Warlock, Wizard
*(Source: XGE, page 163)*
...
- **Components**: V
- **Duration**: Instantaneous
You overwhelm the mind of one creature you can see within range. If the target has 150 Hit Points or fewer, it is [Stunned](conditions.md#stunned). Otherwise, its Speed is 0 until the start of your next turn.
The [Stunned](conditions.md#stunned) target makes a CON Save at the end of each of its turns, ending the condition on itself on a success.
- **Classes**: Bard, Sorcerer, Warlock, Wizard
*(Source: PHB'24, page 306)*
...
- **Components**: V, S
- **Duration**: Instantaneous
A scream from the dawn of creation issues forth from you.
Each creature within 4 *(6m)* of you takes 5d8 Thunder damage and is pushed up to 2 *(3m)* away from you, then each creature of your choice within 6 *(9m)* of you must make a WIS Save. On a failure, the creature is [Frightened](conditions.md#frightened) for the next minute.
...
- **Components**: V, S
- **Duration**: Instantaneous
Eight rays of light flash from you in a length 12 *(18m)* cone. Each creature in the Cone makes a DEX Save. For each target, roll 1d8 to determine which color ray affects it, consulting the Prismatic Rays table.
Prismatic Rays1d8Ray1Red. Failed Save: 12d6 Fire damage. Successful Save: Half as much damage.
...
6Indigo. Failed Save: The target is [Restrained](conditions.md#restrained) and makes a CON Save at the end of each of its turns. If it successfully saves three times, the condition ends. If it fails three times, it is [Petrified](conditions.md#petrified) until it is freed by an effect like the Greater Restoration spell. The successes and failures needn't be consecutive; keep track of both until the target collects three of a kind.
7Violet. Failed Save: The target is [Blinded](conditions.md#blinded) and makes a WIS Save at the start of your next turn. On a successful save, the condition ends. On a failed save, the condition ends, and the creature teleports to another plane of existence (DM's choice).
...
- **Components**: V, S
- **Duration**: 10 minutes
A shimmering, multicolored plane of light forms a vertical opaque wall—up to 18 *(27m)* long, 6 *(9m)* high, and 3cm thick—centered on a point within range. Alternatively, you shape the wall into a globe up to 6 *(9m)* in diameter centered on a point within range. The wall lasts for the duration. If you position the wall in a space occupied by a creature, the spell ends instantly without effect.
The wall sheds Bright Light within 20 *(30m)* and Dim Light for an additional 20 *(30m)*. You and creatures you designate when you cast the spell can pass through and be near the wall without harm. If another creature that can see the wall moves within 4 *(6m)* of it or starts its turn there, the creature must succeed on a CON Save or be [Blinded](conditions.md#blinded) for 1 minute.
...
6Indigo. Failed Save: The target is [Restrained](conditions.md#restrained) and makes a CON Save at the end of each of its turns. If it successfully saves three times, the condition ends. If it fails three times, it is [Petrified](conditions.md#petrified) until it is freed by an effect like the Greater Restoration spell. The successes and failures needn't be consecutive; keep track of both until the target collects three of a kind. Additional Effects: Spells can't be cast through this layer, which is destroyed by Bright Light shed by the Daylight spell.
7Violet. Failed Save: The target is [Blinded](conditions.md#blinded) and makes a WIS Save at the start of your next turn. On a successful save, the condition ends. On a failed save, the condition ends, and the creature teleports to another plane of existence (DM's choice). Additional Effects: This layer is destroyed by Dispel Magic.
- **Classes**: Bard, Wizard
...
- **Components**: V, S
- **Duration**: 10 minutes
A flickering flame appears in your hand and remains there for the duration. While there, the flame emits no heat and ignites nothing, and it sheds Bright Light in a radius 4 *(6m)* sphere and Dim Light for an additional 4 *(6m)*. The spell ends if you cast it again.
...
- **Components**: V, S
- **Duration**: Until dispelled
You create an illusion of an object, a creature, or some other visible phenomenon within range that activates when a specific trigger occurs. The illusion is imperceptible until then. It must be no larger than a size 6 *(9m)* cube, and you decide when you cast the spell how the illusion behaves and what sounds it makes. This scripted performance can last up to 5 minutes.
...
The trigger can be as general or as detailed as you like, though it must be based on visual or audible phenomena that occur within 6 *(9m)* of the area. For example, you could create an illusion of yourself to appear and warn off others who attempt to open a trapped door.
...
You can see through the illusion's eyes and hear through its ears as if you were in its space. As a Magic action, you can move it up to 12 *(18m)* and make it gesture, speak, and behave in whatever way you choose. It mimics your mannerisms perfectly.
Physical interaction with the image reveals it to be illusory, since things can pass through it. A creature that takes the Study action to examine the image can determine that it is an illusion with a successful INT (Investigation) check against your spell save DC. If a creature discerns the illusion for what it is, the creature can see through the image, and any noise it makes sounds hollow to the creature.
- **Classes**: Bard, Wizard
*(Source: PHB'24, page 309)*
...
Each target must make an INT Save. On a failed save, a target takes 14d6 psychic damage and is [stunned](conditions.md#stunned). On a successful save, a target takes half as much damage and isn't [stunned](conditions.md#stunned). If a target is killed by this damage, its head explodes, assuming it has one.
A [stunned](conditions.md#stunned) target can make an INT Save at the end of each of its turns. On a successful save, the stunning effect ends.
- **Classes**: Bard, Sorcerer, Warlock, Wizard
*(Source: XGE, page 163)*
...
- **Components**: V, S
- **Duration**: 8 hours
You touch a living creature, infusing its flesh with the seeds of decay.
...
- **Components**: V, S
- **Duration**: Instantaneous
You touch an object and scour it with exploratory magics, reading elements of its past from lingering auras and choosing one of the following effects:- You learn whether the object has been stolen or acquired by deceit in the last year.
- You learn the number and direction of creatures that have touched the object in the last month.
- You learn which spells have been cast upon the object in the last tenday.
...
- **Components**: V, S
- **Duration**: 1 hour
You touch a rope. One end of it hovers upward until the rope hangs perpendicular to the ground or the rope reaches a ceiling. At the rope's upper end, an [Invisible](conditions.md#invisible) 1-by-1.5-meter portal opens to an extradimensional space that lasts until the spell ends. That space can be reached by climbing the rope, which can be pulled into or dropped out of it.
...
- **Components**: V, S
- **Duration**: Instantaneous
Light flares from your hand to engulf a creature within range, reverberating through any active magical connections bound to it. Make a ranged spell attack against the target.
...
..Save ModifierSecondhand (heard of the target)+5Firsthand (met the target)+0Extensive (know the target well)-5You Have the Target's.
..Save ModifierPicture or other likeness-2Garment or other possession-4Body part, lock of hair, or bit of nail-10On a successful save, the target isn't affected, and you can't use this spell on it again for 24 hours.
On a failed save, the spell creates an [Invisible](conditions.md#invisible), intangible sensor within 2 *(3m)* of the target. You can see and hear through the sensor as if you were there. The sensor moves with the target, remaining within 2 *(3m)* of it for the duration. If something can see the sensor, it appears as a luminous orb about the size of your fist.
...
- **Components**: V, S
- **Duration**: Until dispelled
With a touch, you magically sequester an object or a willing creature. For the duration, the target is [Invisible](conditions.md#invisible) and can't be targeted by Divination spells, detected by magic, or viewed remotely with magic.
If the target is a creature, it enters a state of suspended animation; it is [Unconscious](conditions.md#unconscious), doesn't age, and doesn't need food, water, or air.
You can set a condition for the spell to end early. The condition can be anything you choose, but it must occur or be visible within 1 mile of the target. Examples include ""after 1,000 years"" or ""when the tarrasque awakens.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
Flame-like shadows wreathe your body until the spell ends, causing you to become heavily obscured to others. The shadows turn dim light within 2 *(3m)* of you into darkness, and bright light in the same area to dim light.
Until the spell ends, you have resistance to radiant damage. In addition, whenever a creature within 2 *(3m)* of you hits you with an attack, the shadows lash out at that creature, dealing it 2d8 necrotic damage.
- **Classes**: Warlock
*(Source: XGE, page 164)*
...
- **Components**: V, S
- **Duration**: Instantaneous
A loud noise erupts from a point of your choice within range. Each creature in a radius 2 *(3m)* sphere centered there makes a CON Save, taking 3d8 Thunder damage on a failed save or half as much damage on a successful one. A Construct has Disadvantage on the save.
...
- **Components**: V, S
- **Duration**: Instantaneous
A cloud of hateful seed-crystals swarms a creature you can see within range, boring inside and freezing it from within. The target takes 40 Cold damage.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
Dim, greenish light spreads within a radius 6 *(9m)* sphere centered on a point you choose within range. The light spreads around corners, and it lasts until the spell ends.
When a creature moves into the spell's area for the first time on a turn or starts its turn there, that creature must succeed on a CON Save or take 4d10 radiant damage, and it suffers one level of exhaustion and emits a dim, greenish light in a radius 1 *(1.5m)* sphere. This light makes it impossible for the creature to benefit from being [invisible](conditions.md#invisible). The light and any levels of exhaustion caused by this spell go away when the spell ends.
- **Classes**: Sorcerer, Warlock, Wizard
*(Source: XGE, page 164)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
You create the image of an object, a creature, or some other visible phenomenon that is no larger than a size 3 *(4.5m)* cube. The image appears at a spot within range and lasts for the duration. The image is purely visual; it isn't accompanied by sound, smell, or other sensory effects.
...
Physical interaction with the image reveals it to be an illusion, since things can pass through it. A creature that takes a Study action to examine the image can determine that it is an illusion with a successful INT (Investigation) check against your spell save DC. If a creature discerns the illusion for what it is, the creature can see through the image.
- **Classes**: Bard, Sorcerer, Wizard
...
You can then choose a different creature you can see within range (you can choose yourself). The chosen creature has advantage on the next attack roll, ability check, or Save it makes within 1 minute. A creature can be empowered by only one use of this spell at a time.
- **Classes**: Bard, Sorcerer, Wizard
![\|50](https://bg3.wiki/w/images/3/3b/Draconic_Ancestry_Bronze_Lightning_Icon.webp)
*(Source: SCC, page 38)*
...
If the simulacrum takes damage, the only way to restore its Hit Points is to repair it as you take a Long Rest, during which you expend components worth 100 GP per Hit Point restored. The simulacrum must stay within 1 *(1.5m)* of you for the repair.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You alter time around up to six creatures of your choice in a size 8 *(12m)* cube within range. Each target must succeed on a WIS Save or be affected by this spell for the duration.
...
- **Components**: S
- **Duration**: Instantaneous
You snip carefully away at the threads of magic binding a magical effect or creation into being, altering its effects in one of the following ways:- Whenever the effect or creation deals damage, it deals two fewer dice of damage.
- If the effect or creation has a radius or range, its radius or range is decreased by 2 *(3m)*.
...
- **Components**: V
- **Duration**: 1 minute
ach other creature within range that can hear you must succeed on WIS Save or become hostile to a random creature within 3 *(4.5m)* of it and indifferent to all other creatures for the next minute.
...
- **Borrow Experience.** You can use a bonus action to bolster yourself with the soul's life experience, making your next attack roll, ability check, or Save with advantage. If you don't use this benefit before the start of your next turn, it is lost.
- **Eyes of the Dead.** You can use an action to name a place the humanoid saw in life, which creates an [invisible](conditions.md#invisible) sensor somewhere in that place if it is on the plane of existence you're currently on. The sensor remains for as long as you concentrate, up to 10 minutes (as if you were concentrating on a spell). You receive visual and auditory information from the sensor as if you were in its space using your senses.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
Protective spirits flit around you in a radius 3 *(4.5m)* emanation for the duration. If you are good or neutral, their spectral form appears angelic or fey (your choice). If you are evil, they appear fiendish.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You create a floating, spectral force that resembles a weapon of your choice and lasts for the duration. The force appears within range in a space of your choice, and you can immediately make one melee spell attack against one creature within 1 *(1.5m)* of the force. On a hit, the target takes Force damage equal to 1d8 plus your spellcasting ability modifier.
...
You then teleport to an unoccupied space you can see within 1 *(1.5m)* of one of the targets.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
Oily acid pours down in a radius 2 *(3m)* sphere, height 8 *(12m)* Cylinder within range for the duration, igniting plumes of lightless flame where it touches.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
A churning storm cloud forms for the duration, centered on a point within range and spreading to a radius of 60 *(90m)*. Each creature under the cloud when it appears must succeed on a CON Save or take 2d6 Thunder damage and be [Deafened](conditions.md#deafened) for the duration.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You launch a sunbeam in a undefined, undefined Line. Each creature in the Line makes a CON Save. On a failed save, a creature takes 6d8 Radiant damage and is [Blinded](conditions.md#blinded) until the start of your next turn. On a successful save, it takes half as much damage only.
...
- **Components**: V, S
- **Duration**: Instantaneous
Brilliant sunlight flashes in a radius 12 *(18m)* sphere centered on a point you choose within range. Each creature in the Sphere makes a CON Save. On a failed save, a creature takes 12d6 Radiant damage and is [Blinded](conditions.md#blinded) for 1 minute. On a successful save, it takes half as much damage only.
A creature [Blinded](conditions.md#blinded) by this spell makes another CON Save at the end of each of its turns, ending the effect on itself on a success.
...
- **Components**: V
- **Duration**: Instantaneous
You create a momentary circle of spectral blades that sweep around you. All other creatures within 1 *(1.5m)* of you must succeed on a DEX Save or take 1d6 force damage.
...
- **Components**: V, S
- **Duration**: Instantaneous
You cause psychic energy to erupt at a point within range. Each creature in a radius 4 *(6m)* sphere centered on that point makes an INT Save, taking 8d6 Psychic damage on a failed save or half as much damage on a successful one.
...
- **Components**: V, S
- **Duration**: 10 minutes
You conjure a claw-footed cauldron filled with bubbling liquid. The cauldron appears in an unoccupied space on the ground within 1 *(1.5m)* of you and lasts for the duration. The cauldron can't be moved and disappears when the spell ends, along with the bubbling liquid inside it.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
Uttering an incantation, you draw on the magic of the Lower Planes or Upper Planes (your choice) to transform yourself. You gain the following benefits until the spell ends:You are immune to fire and poison damage (Lower Planes) or radiant and necrotic damage (Upper Planes).
...
Spectral wings appear on your back, giving you a flying speed of 8 *(12m)*.
...
Teleportation OutcomeFamiliarityMishapSimilar AreaOff TargetOn TargetPermanent circle———01-00Linked object———01-00Very familiar01-0506-1314-2425-00Seen casually01-3334-4344-5354-00Viewed once or described01-4344-5354-7374-00False destination01-5051-00—— Familiarity. Here are the meanings of the terms in the table's Familiarity column:""Permanent circle"" means a permanent teleportation circle whose sigil sequence you know.
...
- **Components**: V, S
- **Duration**: 1 hour
This spell creates a circular, horizontal plane of force, 1 meter in diameter and 3cm thick, that floats 1 meter above the ground in an unoccupied space of your choice that you can see within range. The disk remains for the duration and can hold up to 250kg. If more weight is placed on it, the spell ends, and everything on the disk falls to the ground.
The disk is immobile while you are within 4 *(6m)* of it. If you move more than 4 *(6m)* away from it, the disk follows you so that it remains within 4 *(6m)* of you. It can move across uneven terrain, up or down stairs, slopes and the like, but it can't cross an elevation change of 2 *(3m)* or more. For example, the disk can't move across a depth 2 *(3m)* pit, nor could it leave such a pit if it was created at the bottom.
If you move more than 20 *(30m)* from the disk (typically because it can't move around an obstacle to follow you), the spell ends.
- **Classes**: Wizard
*(Source: PHB'24, page 332)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
You endow yourself with endurance and martial prowess fueled by magic. Until the spell ends, you can't cast spells, and you gain the following benefits:You gain 50 temporary hit points. If any of these remain when the spell ends, they are lost.
You have advantage on attack rolls that you make with simple and martial weapons.
When you hit a target with a weapon attack, that target takes an extra 2d12 force damage.
You have proficiency with all armor, shields, simple weapons, and martial weapons.
You have proficiency in STR and CON Saves.
You can attack twice, instead of once, when you take the Attack action on your turn. You ignore this benefit if you already have a feature, like Extra Attack, that gives you extra attacks.
Immediately after the spell ends, you must succeed on a DC 15 CON Save or suffer one level of exhaustion.
- **Classes**: Wizard
*(Source: XGE, page 168)*
...
- **Components**: S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
Your eyes flash with dread, implacable fury.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 round
A point of fire appears in the sky above you, growing second by second as it hurtles toward earth. Each creature and object within 100 *(150m)* of you immediately begins [Blinded](conditions.md#blinded) (1d10).
...
This spell ends if one of the actions you use during this period, or any effects that you create during it, affects a creature other than you or an object being worn or carried by someone other than you. In addition, the spell ends if you move to a place more than 1,0 *(0m)* from the location where you cast it.
- **Classes**: Sorcerer, Wizard
*(Source: PHB'24, page 334)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You gain the ability to enter a tree and move from inside it to inside another tree of the same kind within 100 *(150m)*. Both trees must be living and at least the same size as you. You must use 1 *(1.5m)* of movement to enter a tree. You instantly know the location of all other trees of the same kind within 100 *(150m)* and, as part of the move used to enter the tree, can either pass into one of those trees or step out of the tree you're in. You appear in a spot of your choice within 1 *(1.5m)* of the destination tree, using another 1 *(1.5m)* of movement. If you have no movement left, you appear within 1 *(1.5m)* of the tree you entered.
...
The spell can provide a new body if the original no longer exists, in which case you must speak the creature's name. The creature then appears in an unoccupied space you choose within 2 *(3m)* of you.
- **Classes**: Cleric, Druid
...
A wall of water springs into existence at a point you choose within range. You can make the wall up to 60 *(90m)* long, 60 *(90m)* high, and 10 *(15m)* thick. The wall lasts for the duration.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You bend the light in a length 12 *(18m)* cone extending from you, becoming [Invisible](conditions.md#invisible) to creatures in the area until you move or take an action.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
One creature you can see within range sinks into its own shadow (no Save), falling into the great nothing that lies beneath and before everything.
...
- **Components**: V, S
- **Duration**: 1 hour
This spell creates an [Invisible](conditions.md#invisible), mindless, shapeless, Medium force that performs simple tasks at your command until the spell ends. The servant springs into existence in an unoccupied space on the ground within range. It has AC 10, 1 Hit Point, and a STR of 2, and it can't attack. If it drops to 0 Hit Points, the spell ends.
Once on each of your turns as a Bonus Action, you can mentally command the servant to move up to 3 *(4.5m)* and interact with an object. The servant can perform simple tasks that a human could do, such as fetching things, cleaning, mending, folding clothes, lighting fires, serving food, and pouring drinks. Once you give the command, the servant performs the task to the best of its ability until it completes the task, then waits for your next command.
...
- **Components**: V, S
- **Duration**: 1 round
You attempt to share a truth with a creature its mind cannot contain. Make a melee spell attack against the target. On a hit, the target takes 3d10 force plus 6d12 Psychic damage and must make a WIS Save.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You create a wall of fire on a solid surface within range. You can make the wall up to 12 *(18m)* long, 4 *(6m)* high, and 30cm thick, or a ringed wall up to 4 *(6m)* in diameter, 4 *(6m)* high, and 30cm thick. The wall is opaque and lasts for the duration.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
You create a wall of ice on a solid surface within range. You can form it into a hemispherical dome or a globe with a radius of up to 2 *(3m)*, or you can shape a flat surface made up of tena size 2 *(3m)* square panels. Each panel must be contiguous with another panel. In any form, the wall is 30cm thick and lasts for the duration.
...
The wall is an object that can be damaged and thus breached. It has AC 12 and 30 Hit Points per size 2 *(3m)* section, and it has Immunity to Cold, Poison, and Psychic damage and Vulnerability to Fire damage. Reducing a size 2 *(3m)* section of wall to 0 Hit Points destroys it and leaves behind a sheet of frigid air in the space the wall occupied.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
A nonmagical wall of solid stone springs into existence at a point you choose within range. The wall is 15cm thick and is composed of ten 3-by-3 meters panels. Each panel must be contiguous with another panel. Alternatively, you can create 3-by-6 meters panels that are only 8cm thick.
...
If you create a span greater than 4 *(6m)* in length, you must halve the size of each panel to create supports. You can crudely shape the wall to create battlements and the like.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
You create a wall of water on the ground at a point you can see within range. You can make the wall up to 6 *(9m)* long, 2 *(3m)* high, and 30cm thick, or you can make a ringed wall up to 4 *(6m)* in diameter, 4 *(6m)* high, and 30cm thick. The wall vanishes when the spell ends. The wall's space is difficult terrain.
...
- **Components**: V
- **Duration**: [Concentration](conditions.md#concentration), up to 10 minutes
A strong wind (20 miles per hour) blows around you in a radius 2 *(3m)* sphere and moves with you, remaining centered on you. The wind lasts for the spell's duration.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You conjure up a sphere of water with a radius 1 *(1.5m)* sphere at a point you can see within range. The sphere can hover but no more than 2 *(3m)* off the ground. The sphere remains for the spell's duration.
Any creature in the sphere's space must make a STR Save. On a successful save, a creature is ejected from that space to the nearest unoccupied space of the creature's choice outside the sphere. A Huge or larger creature succeeds on the Save automatically, and a Large or smaller creature can choose to fail it. On a failed save, a creature is [restrained](conditions.md#restrained) by the sphere and is engulfed by the water. At the end of each of its turns, a [restrained](conditions.md#restrained) target can repeat the Save, ending the effect on itself on a success.
The sphere can restrain as many as four Medium or smaller creatures or one Large creature. If the sphere restrains a creature that causes it to exceed this capacity, a random creature that was already [restrained](conditions.md#restrained) by the sphere falls out of it and lands [prone](conditions.md#prone) in a space within 1 *(1.5m)* of it.
As an action, you can move the sphere up to 6 *(9m)* in a straight line. If it moves over a pit, a cliff, or other drop-off, it safely descends until it is hovering 2 *(3m)* above the ground. Any creature [restrained](conditions.md#restrained) by the sphere moves with it. You can ram the sphere into creatures, forcing them to make the Save.
When the spell ends, the sphere falls to the ground and extinguishes all normal flames within 6 *(9m)* of it. Any creature [restrained](conditions.md#restrained) by the sphere is knocked [prone](conditions.md#prone) in the space where it falls. The water then vanishes.
- **Classes**: Druid, Sorcerer, Wizard
*(Source: XGE, page 170)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 hour
You conjure a mass of sticky webbing at a point within range. The webs fill a size 4 *(6m)* cube there for the duration. The webs are Difficult Terrain, and the area within them is Lightly Obscured.
If the webs aren't anchored between two solid masses (such as walls or trees) or layered across a floor, wall, or ceiling, the web collapses on itself, and the spell ends at the start of your next turn. Webs layered over a flat surface have a depth of 1 *(1.5m)*.
The first time a creature enters the webs on a turn or starts its turn there, it must succeed on a DEX Save or be [Restrained](conditions.md#restrained) while in the webs or until it breaks free.
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
You try to create illusory terrors in others' minds. Each creature of your choice in a radius 6 *(9m)* sphere centered on a point within range makes a WIS Save. On a failed save, a target takes 10d10 Psychic damage and is [Frightened](conditions.md#frightened) for the duration. On a successful save, a target takes half as much damage only.
A [Frightened](conditions.md#frightened) target makes a WIS Save at the end of each of its turns. On a failed save, it takes 5d10 Psychic damage. On a successful save, the spell ends on that target.
- **Classes**: Warlock, Wizard
...
A [restrained](conditions.md#restrained) creature can use an action to make a STR or DEX check against your spell save DC. If successful, the creature is no longer [restrained](conditions.md#restrained) by the whirlwind and is hurled 3d6 × 2 *(3m)* away from it in a random direction.
- **Classes**: Druid, Sorcerer, Wizard
*(Source: XGE, page 171)*
...
- **Components**: V, S
- **Duration**: [Concentration](conditions.md#concentration), up to 1 minute
A wall of strong wind rises from the ground at a point you choose within range. You can make the wall up to 10 *(15m)* long, 3 *(4.5m)* high, and 30cm thick. You can shape the wall in any way you choose so long as it makes one continuous path along the ground. The wall lasts for the duration.
...
Once before the spell ends, you can give yourself advantage on one weapon attack roll on your turn. That attack deals an extra 1d8 force damage on a hit. Whether you hit or miss, your walking speed increases by 6 *(9m)* until the end of that turn.
- **Classes**: Ranger
*(Source: XGE, page 171)*
