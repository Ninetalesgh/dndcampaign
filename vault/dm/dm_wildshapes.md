...
- **Reactions**:
   - **Curl Up**. As a Reaction when you are targeted with an attack or make a Save, you curl into a ball, gaining the following effects until the beginning of your next turn.
   You are blinded.
...
- **Traits**:
   ...
   - **Shifting Scales**. As a Bonus Action, you may match your appearance to your surroundings, becoming invisible to creatures more than 2 *(3m)* away from you until you move or make an attack.
   - **Magic Resistance**. You have advantage on Saves against spells and other magical effects.
- **Actions**:
   - **Slinking Sting**. *Melee Attack*: +4 to hit, reach 1 *(1.5m)*, one target. 
    *Hit*: 1d4 + 2 Piercing damage.
   Before or after making this attack, you may move up to 1 *(1.5m)* without provoking attacks of opportunity.
   - **Drowsy Sting**. *Melee Attack*: +4 to hit, reach 1 *(1.5m)*, one creature. 
...
- **Actions**:
   ...
   This attack has Advantage against a creature that made an Opportunity Attack this turn.
   - **Tail Whip**. *Melee Attack*: +4 to hit, reach 2 *(3m)*, one target. 
    *Hit*: 1d10 + 2 Bludgeoning damage and the target is pushed up to 1 *(1.5m)* away.
   On a critical hit, the target must succeed on a DC 12 CON Save or be Stunned until the end of its next turn.
   - **Vigilant Stance**. You take up a wary stance, making a WIS (Perception) check with advantage.
   Until the beginning of your next turn, you can use your Reaction to move up to your speed whenever a Hidden creature within 6 *(9m)* reveals its position.
- **Reactions**:
...
- **Actions**:
   ...
   - **Claws**. *Melee Attack*: +5 to hit, reach 1 *(1.5m)*, one target. 
...
- **Senses**: passive perception 12
- **Traits**:
   - **Standing Leap**. Your long jump is up to 5 *(7.5m)* and your high jump is up to 3 *(4.5m)*, with or without a running start.
   - **Spider Climb.** You can climb difficult surfaces, including upside down on ceilings, without needing to make an ability check.
   - **Poisonous Skin**. A creature that comes into contact with your skin must succeed on a DC 12 CON Save or be Poisoned until the end of its next turn. While poisoned in this way, a creature that is not drenched in water must use its turn to move toward the nearest source of water and drench itself, if there is any.
- **Actions**:
   - **Multiattack**. You make two attacks.
   - **Poison Sting**. *Melee Attack*: +4 to hit, reach 1 *(1.5m)*, one target. 
    *Hit*: 1d4 + 2 Piercing damage plus 2d4 Poison damage and the target must succeed on a DC 12 CON Save or be affected by your Poisonous Skin.
   - **Poison Shot**. *Ranged Attack*: +4 to hit, range 5/20 *(7.5m/30m)*, one target. 
    *Hit*: 1d4 + 1 Piercing damage plus 2d4 Poison damage and the target must succeed on a DC 12 CON Save or be affected by your Poisonous Skin.
- **Reactions**:
   - **Spring Away**. As a Reaction to being missed with an attack, you can move up to your speed without provoking attacks of opportunity.
